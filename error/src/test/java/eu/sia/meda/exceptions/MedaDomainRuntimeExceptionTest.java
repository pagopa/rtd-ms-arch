...
public class MedaDomainRuntimeExceptionTest {
    ...
    public void testConsturctors(){
        MedaDomainRuntimeException exception = new MedaDomainRuntimeException(MESSAGE,CODE, HttpStatus.BAD_REQUEST);
        ...
        Assert.assertTrue(exception.getAdditionalInfo().isEmpty());
        Assert.assertNull(exception.getRawRemoteError());
        Assert.assertNull(exception.getRemoteSource());

        exception = new MedaDomainRuntimeException(MESSAGE,CODE, HttpStatus.BAD_REQUEST, MedaErrorTypeEnum.TECHNICAL, MedaSeverityEnum.FATAL);
        Assert.assertNotNull(exception);
        Assert.assertEquals(MESSAGE,exception.getMessage());
        Assert.assertEquals(CODE,exception.getCode());
        Assert.assertEquals(HttpStatus.BAD_REQUEST,exception.getResponseStatus());
        ...
        exception = new MedaDomainRuntimeException(MESSAGE,CODE, HttpStatus.BAD_REQUEST, MedaErrorTypeEnum.TECHNICAL, MedaSeverityEnum.FATAL,additionalInfo);
        Assert.assertNotNull(exception);
        Assert.assertEquals(MESSAGE,exception.getMessage());
        Assert.assertEquals(CODE,exception.getCode());
        Assert.assertEquals(HttpStatus.BAD_REQUEST,exception.getResponseStatus());
        ...
        exception = new MedaDomainRuntimeException(MESSAGE,CODE, HttpStatus.BAD_REQUEST, MedaErrorTypeEnum.TECHNICAL, MedaSeverityEnum.FATAL,RAW_REMOTE_ERROR,REMOTE_SOURCE);
        Assert.assertNotNull(exception);
        Assert.assertEquals(MESSAGE,exception.getMessage());
        Assert.assertEquals(CODE,exception.getCode());
        Assert.assertEquals(HttpStatus.BAD_REQUEST,exception.getResponseStatus());
        ...
        exception = new MedaDomainRuntimeException(MESSAGE,CODE, HttpStatus.BAD_REQUEST, MedaErrorTypeEnum.TECHNICAL, MedaSeverityEnum.FATAL,additionalInfo,RAW_REMOTE_ERROR,REMOTE_SOURCE);
        Assert.assertNotNull(exception);
        Assert.assertEquals(MESSAGE,exception.getMessage());
        Assert.assertEquals(CODE,exception.getCode());
        Assert.assertEquals(HttpStatus.BAD_REQUEST,exception.getResponseStatus());

...
public class ArchEventListenerConfigurationService {
    ...
    */
   public ArchEventListenerConfigurationService.EventListenerConfiguration retrieveEventConfiguration(String className) {
      ...
      if (this.propertiesManager.containsConnectorProperty(CONNECTOR_TYPE, className, "topic")) {
         ...
         config.setConcurrency((Integer)this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE, className, "concurrency", Integer.class));

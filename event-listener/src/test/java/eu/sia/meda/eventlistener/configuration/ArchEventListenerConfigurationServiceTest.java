...
public class ArchEventListenerConfigurationServiceTest {
    ...
    public void testGetRetries() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setRetries(2);
        Integer retries = archEventListenerConfigurationService_EventListenerConfiguration0.getRetries();
        Assert.assertNotNull(retries);
        Assert.assertEquals(Integer.valueOf(2), retries);
    }

    @Test
    public void testGetAckMode() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setAckMode("testAckMode");
        String ackMode = archEventListenerConfigurationService_EventListenerConfiguration0.getAckMode();
        Assert.assertTrue(Strings.isNotEmpty(ackMode));
        Assert.assertEquals("testAckMode", ackMode);
    }

    @Test
    public void testGetAckCount() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setAckCount(2);
        Integer ackCount = archEventListenerConfigurationService_EventListenerConfiguration0.getAckCount();
        Assert.assertNotNull(ackCount);
        Assert.assertEquals(Integer.valueOf(2), ackCount);
    }

    @Test
    public void testGetAckTime() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setAckTime(3);
        Integer ackTime = archEventListenerConfigurationService_EventListenerConfiguration0.getAckTime();
        Assert.assertNotNull(ackTime);
        Assert.assertEquals(Integer.valueOf(3), ackTime);
    }

    @Test
    public void testGetPoolSize() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setPoolSize(4);
        Integer poolSize = archEventListenerConfigurationService_EventListenerConfiguration0.getPoolSize();
        Assert.assertNotNull(poolSize);
        Assert.assertEquals(Integer.valueOf(4), poolSize);
    }

    @Test
    public void testIsSinglePool() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setSinglePool(true);
        boolean singlePool = archEventListenerConfigurationService_EventListenerConfiguration0.isSinglePool();
        Assert.assertTrue(singlePool);
    }

    @Test
    public void testGetSaslMechanism() {
        ArchEventListenerConfigurationService.EventListenerConfiguration archEventListenerConfigurationService_EventListenerConfiguration0 = new ArchEventListenerConfigurationService.EventListenerConfiguration();
        archEventListenerConfigurationService_EventListenerConfiguration0.setSaslMechanism("testSaslMechanism");
        String saslMechanism = archEventListenerConfigurationService_EventListenerConfiguration0.getSaslMechanism();
        Assert.assertTrue(Strings.isNotEmpty(saslMechanism));
        Assert.assertEquals("testSaslMechanism", saslMechanism);
    }
}

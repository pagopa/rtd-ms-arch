...
/**
 * The Class DeleteTransactionInfoRestRequestTransformer.
 */
@Service
@Conditional({EnabledTransactionManagerCondition.class})
public class DeleteTransactionInfoRestRequestTransformer implements IRestRequestTransformer<String, Void> {
   ...
   public RestConnectorRequest<Void> transform(String idOp, Object... args) {
      ...
      RestConnectorRequest<Void> restConnectorRequest = new RestConnectorRequest(headers, (Object)null, parametersMap, new HashMap(), HttpMethod.DELETE);

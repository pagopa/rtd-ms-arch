...
public class ArchMedaInternalConnectorConfigurationService {
   ...
   public ArchMedaInternalConnectorConfigurationService.MedaInternalConfiguration retrieveRestConfiguration(String className) {
      ...
      if (this.propertiesManager.containsConnectorProperty(CONNECTOR_TYPE, className, "url")) {
         ...
         config.setEnabledTracing((Boolean)this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE, className, "enabledTracing", Boolean.class));
         config.setAuditEnabled((Boolean)this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE, className, "auditEnabled", Boolean.class));
    ...
    */
   public static class MedaInternalConfiguration implements IHttpConnectionPoolConfigurationAware, AuditableConnectorConfiguration {

...
public abstract class MedaCoreConnector<INPUT, OUTPUT, DTO, RESOURCE> {
   ...
   private void init() {
      ...
      if (myConfiguration == null) {
         ...
         try {
            this.coreRestConnector = new MedaCoreRestConnector(connectorName + "_CORE", myConfiguration);
            this.beanFactory.autowireBean(this.coreRestConnector);
            this.coreRestConnector = (MedaCoreRestConnector)this.beanFactory.initializeBean(this.coreRestConnector, connectorName + "_CORE");

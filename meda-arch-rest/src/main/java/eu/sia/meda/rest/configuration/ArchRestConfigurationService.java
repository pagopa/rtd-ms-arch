...
public class ArchRestConfigurationService {
	...
	public ArchRestConfigurationService.RestConfiguration retrieveRestConfiguration(String className) {
		ArchRestConfigurationService.RestConfiguration config;
		if (this.propertiesManager.containsConnectorProperty(CONNECTOR_TYPE, className, "url")) {
			config = new ArchRestConfigurationService.RestConfiguration();
			config.setUrl((String) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE, className,
					"url", String.class));
			config.setTimeout((Integer) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE,
					className, "timeout", Integer.TYPE));
			config.setMocked((Boolean) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE,
					className, "mocked", Boolean.class, false));
			config.setPath((String) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE, className,
					"path", String.class));
			config.setRandomMock((Boolean) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE,
					className, "randomMock", Boolean.class));
			config.setFiles(
					this.propertiesManager.getConnectorPropertyList(CONNECTOR_TYPE, className, "files", String.class));
			config.setEnabledTracing((Boolean) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE,
					className, "enabledTracing", Boolean.class));
			config.setAuditEnabled((Boolean) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE,
					className, "auditEnabled", Boolean.class));
			config.setCodService((String) this.propertiesManager.getConnectorProperty(CONNECTOR_TYPE,
					className, "codService", String.class));
			config.setConnectionPoolConfiguration(HttpConnectionPoolConfiguration
					.loadFromProperties(this.propertiesManager, CONNECTOR_TYPE, className));
	...
	public static class RestConfiguration
		 ...
		 */
		public RestConfiguration(
				ArchMedaInternalConnectorConfigurationService.MedaInternalConfiguration configuration) {
			...
			this.copyHeaders = configuration.isCopyHeaders();
		}

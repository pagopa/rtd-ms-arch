...
public class ArchEventConfigurationServiceTest {
    ...
    public void testGetSaslMechanism() {
        ArchEventConfigurationService.EventConfiguration archEventConfigurationService_EventConfiguration0 = new ArchEventConfigurationService.EventConfiguration();
        archEventConfigurationService_EventConfiguration0.setSaslMechanism("testMechanism");
        String saslMechanism = archEventConfigurationService_EventConfiguration0.getSaslMechanism();
        Assert.assertTrue(Strings.isNotEmpty(saslMechanism));
        Assert.assertEquals("testMechanism", saslMechanism);
    }

    @Test
    public void testGetRetries() {
        ArchEventConfigurationService.EventConfiguration archEventConfigurationService_EventConfiguration0 = new ArchEventConfigurationService.EventConfiguration();
        archEventConfigurationService_EventConfiguration0.setRetries(2);
        Integer retries = archEventConfigurationService_EventConfiguration0.getRetries();
        Assert.assertNotNull(retries);
        Assert.assertEquals(Integer.valueOf(2), retries);
    }

    @Test
    public void testGetConnectionMaxIdleMs() {
        ArchEventConfigurationService.EventConfiguration archEventConfigurationService_EventConfiguration0 = new ArchEventConfigurationService.EventConfiguration();
        archEventConfigurationService_EventConfiguration0.setConnectionMaxIdleMs(3L);
        Long connectionMaxIdleMs = archEventConfigurationService_EventConfiguration0.getConnectionMaxIdleMs();
        Assert.assertNotNull(connectionMaxIdleMs);
        Assert.assertEquals(3L, (long) connectionMaxIdleMs);
    }

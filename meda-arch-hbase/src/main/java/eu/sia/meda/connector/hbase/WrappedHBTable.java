...
import eu.sia.meda.connector.hbase.exception.DuplicateCodecFlagForRowKeyException;
 ...
 * @param <T> Entity type
 */
public class WrappedHBTable<R extends Serializable & Comparable<R>, T extends HBRecord<R>> {
    ...
    public WrappedHBTable(Class<T> clazz) {
        this.clazz = clazz;

...
public abstract class HBaseConnector<T extends HBRecord<R>, R extends Serializable & Comparable<R>> {
     ...
     * <p>
     * <br>
     * <b>Note: </b>If you want to use the default {@link HBObjectMapper}, just use the constructor {@link #HBaseConnector(Configuration)}
     *
    ...
    protected HBaseConnector(Connection connection, HBObjectMapper hbObjectMapper) {
     ...
     * @throws IllegalStateException Annotation(s) on base entity may be incorrect
     */
    protected HBaseConnector(Configuration configuration, HBObjectMapper hbObjectMapper) throws IOException {
     ...
     * <p>
     * <b>Note: </b>If you want to use the default codec, just use the constructor {@link #HBaseConnector(Connection)}
     *
     * @param connection HBase Connection
     * @param codec      Your custom codec. If <code>null</code>, default codec is used.
     * @throws IllegalStateException Annotation(s) on base entity may be incorrect
     */
    protected HBaseConnector(Connection connection, Codec codec) {
     ...
     * Constructs a data access object using your custom codec
     * <p>
     * <b>Note: </b>If you want to use the default codec, just use the constructor {@link #HBaseConnector(Configuration)}
     *
     * @param configuration Hadoop configuration
     * @param codec         Your custom codec. If <code>null</code>, default codec is used.
     * @throws IOException           Exceptions thrown by HBase
     * @throws IllegalStateException Annotation(s) on base entity may be incorrect
     */
    protected HBaseConnector(Configuration configuration, Codec codec) throws IOException {
     ...
     * @throws IllegalStateException Annotation(s) on base entity may be incorrect
     */
    protected HBaseConnector(Connection connection) throws IOException {
     ...
     * @throws IllegalStateException Annotation(s) on base entity may be incorrect
     */
    protected HBaseConnector(Configuration configuration) throws IOException {

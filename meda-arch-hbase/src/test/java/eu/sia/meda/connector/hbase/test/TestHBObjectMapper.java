...
import static eu.sia.meda.connector.hbase.test.TestObjects.validObjects;
...
import eu.sia.meda.connector.hbase.exception.EmptyConstructorInaccessibleException;
import eu.sia.meda.connector.hbase.exception.FieldsMappedToSameColumnException;
import eu.sia.meda.connector.hbase.exception.ImproperHBTableAnnotationExceptions;
import eu.sia.meda.connector.hbase.exception.IncompatibleFieldForHBColumnMultiVersionAnnotationException;
import eu.sia.meda.connector.hbase.exception.MappedColumnCantBePrimitiveException;
import eu.sia.meda.connector.hbase.exception.MappedColumnCantBeStaticException;
import eu.sia.meda.connector.hbase.exception.MappedColumnCantBeTransientException;
import eu.sia.meda.connector.hbase.exception.MissingHBColumnFieldsException;
import eu.sia.meda.connector.hbase.exception.MissingHBRowKeyFieldsException;
import eu.sia.meda.connector.hbase.exception.NoEmptyConstructorException;
import eu.sia.meda.connector.hbase.exception.ObjectNotInstantiatableException;
import eu.sia.meda.connector.hbase.exception.RowKeyCantBeComposedException;
import eu.sia.meda.connector.hbase.exception.RowKeyCantBeEmptyException;
import eu.sia.meda.connector.hbase.exception.RowKeyCouldNotBeParsedException;
import eu.sia.meda.connector.hbase.test.entity.Citizen;
import eu.sia.meda.connector.hbase.test.entity.CitizenSummary;
import eu.sia.meda.connector.hbase.test.entity.ClassWithBadAnnotationStatic;
import eu.sia.meda.connector.hbase.test.entity.ClassWithBadAnnotationTransient;
import eu.sia.meda.connector.hbase.test.entity.ClassWithNoEmptyConstructor;
import eu.sia.meda.connector.hbase.test.entity.ClassWithNoHBColumns;
import eu.sia.meda.connector.hbase.test.entity.ClassWithNoHBRowKeys;
import eu.sia.meda.connector.hbase.test.entity.ClassWithPrimitives;
import eu.sia.meda.connector.hbase.test.entity.ClassWithTwoFieldsMappedToSameColumn;
import eu.sia.meda.connector.hbase.test.entity.ClassesWithFieldIncompatibleWithHBColumnMultiVersion;
import eu.sia.meda.connector.hbase.test.entity.ClassesWithInvalidHBTableAnnotation;
...
import eu.sia.meda.connector.hbase.test.entity.EmployeeSummary;
import eu.sia.meda.connector.hbase.test.entity.Singleton;
import eu.sia.meda.connector.hbase.test.entity.UninstantiatableClass;
...
public class TestHBObjectMapper {
	...
	public void testInvalidRowKey() {
		Assertions.assertThrows(RowKeyCouldNotBeParsedException.class, () -> {
			hbMapper.readValue(hbMapper.toIbw("invalid row key"), hbMapper.writeValueAsPut(validObjects.get(0)),
					Citizen.class);
		});
	}

...
import static eu.sia.meda.connector.hbase.test.util.LiteralsUtil.a;
import static eu.sia.meda.connector.hbase.test.util.LiteralsUtil.e;
import static eu.sia.meda.connector.hbase.test.util.LiteralsUtil.m;
import static eu.sia.meda.connector.hbase.test.util.LiteralsUtil.nm;
import static eu.sia.meda.connector.hbase.test.util.LiteralsUtil.s;
...
import eu.sia.meda.connector.hbase.codec.JavaObjectStreamCodec;
import eu.sia.meda.connector.hbase.test.dao.CitizenDAO;
import eu.sia.meda.connector.hbase.test.dao.CitizenSummaryDAO;
import eu.sia.meda.connector.hbase.test.dao.CounterDAO;
import eu.sia.meda.connector.hbase.test.dao.CrawlDAO;
import eu.sia.meda.connector.hbase.test.dao.CrawlNoVersionDAO;
import eu.sia.meda.connector.hbase.test.dao.EmployeeDAO;
import eu.sia.meda.connector.hbase.test.entity.Citizen;
import eu.sia.meda.connector.hbase.test.entity.Contact;
...
import eu.sia.meda.connector.hbase.test.entity.Dependents;
import eu.sia.meda.connector.hbase.test.entity.Employee;
import eu.sia.meda.connector.hbase.test.util.cluster.HBaseCluster;
import eu.sia.meda.connector.hbase.test.util.cluster.InMemoryHBaseCluster;
